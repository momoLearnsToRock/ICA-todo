...
export class ActivitiesTagsTable extends h.Helpers.SqlTableType {
  ...
  async customInsertChecks(jsonBody: JSON, table) {
    ...
    const tagsTable: h.Helpers.SqlTableType = new h.Helpers.SqlTableType({ connectionPool: this.connectionPool, tableName: 'tags', viewName: 'tags', fields: tagFields, autoGeneratedPrimaryKey: true, throwOnExtraFields: true });
