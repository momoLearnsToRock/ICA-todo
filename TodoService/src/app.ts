...
class main {
  public run(): void {
    ...
    const pool: sql.ConnectionPool = new sql.ConnectionPool(config, (err) => {
      ...
      const categoriesTable: h.Helpers.SqlTableType=  new h.Helpers.SqlTableType({ connectionPool: pool, tableName: 'categories', fields: categoriesFields, autoGeneratedPrimaryKey: false});
