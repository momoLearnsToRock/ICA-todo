        ...
        this.router
            ...
            (function query() {
                return __awaiter(this, void 0, void 0, function* () {
                    try {
                        let reqUrl = `$filter=activityId eq ${req.params.activityId}`;
                        let rslt = yield this.table.activityCardsTable.getAll(reqUrl);
                        res.send(rslt);
                    }
                    catch (err) {
                        console.log(err);
            ...
            (function query() {
                return __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        req.body.activityId = req.params.activityId;
                        let insResult = yield this.table.activityCardsTable.insert(req.body, true); // the second parameter makes sure all the needed fields are passed
                        res.status(201).send(insResult);
                    }
                    catch (err) {
                        let code = 500;
            ...
            (function query() {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        result = yield this.table.activityCardsTable.update(req.body, req.params.cardId, true); // the last argument makes sure to throw an error if there is a field missing (otherwise it should be patch)
                        res.send(result);
                    }
                    catch (err) {
                        let code = 500;
            ...
            (function query() {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        result = yield this.table.activityCardsTable.update(req.body, req.params.cardId, false);
                        res.send(result);
                    }
                    catch (err) {
                        let code = 500;
            ...
            (function query() {
                return __awaiter(this, void 0, void 0, function* () {
                    try {
                        ...
                        yield this.table.activityCardsTable.delete(req.activityCardById.id);
                        res.status(204).send();
                    }
                    catch (err) {
                        let code = 500;
