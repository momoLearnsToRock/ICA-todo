...
class ActivitiesTagsTable extends h.Helpers.SqlTableType {
    ...
    customInsertChecks(jsonBody, table) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tagsTable = new h.Helpers.SqlTableType({ connectionPool: this.connectionPool, tableName: 'tags', viewName: 'tags', fields: tagFields, autoGeneratedPrimaryKey: true, throwOnExtraFields: true });
